...
def train(cfg: DictConfig) -> None:
    ...
    train_path = "/gcs/mlops-project-pneumonia-bucket/processed/train.pt"  # mounted bucket path
    val_path   = "/gcs/mlops-project-pneumonia-bucket/processed/val.pt"

    print(f"Loading preprocessed data from {train_path} and {val_path} ...")
    ...
    with profile(activities=[ProfilerActivity.CPU],
        ...
        for epoch in range(cfg.training.epochs):
            ...
            Path("/gcs/<my-bucket-name>/outputs/models").mkdir(parents=True, exist_ok=True)
            model_path = Path("/gcs/<my-bucket-name>/outputs/models") / f"{cfg.model.name}_best.pth"
    ...
    prof.export_chrome_trace(Path("/gcs/<my-bucket-name>/outputs/models") / "trace.json")
    print(f"\nChrome trace saved to /gcs/<my-bucket-name>/outputs/models/trace.json")
    wandb.finish()
