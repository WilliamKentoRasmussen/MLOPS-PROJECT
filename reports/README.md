...
curl -X POST https://backendv2-1031863562600.europe-west1.run.app/predict \
  -H "Accept: application/json" \
  -F "file=@image.jpeg"

Additionally, it can also be run using the docs with this url https://backend-1031863562600.europe-west1.run.app/docs
